...
{
    public abstract class SoulSkullINFO : Minion
    {
        protected float idleAccel = 0.05f;
        protected float spacingMult = 1f;
        protected float viewDist = 1f;       //minion view Distance
        protected float chaseDist = 100f;       //how far the minion can go 
        protected float chaseAccel = 6f;
        protected float inertia = 40f;
        protected float shootCool = 16f;       //how fast the minion can shoot 
