...
namespace ElementsAwoken.EASystem.ModSupport
{
    public class BossChecklistSuport : ModSystem
    {
        ...
        private void DoBossChecklistIntegration()
        {
            ...
            bossChecklistMod.Call("LogEvent", Mod, internalName = "DotvEvent", weight = 18.4f, downed = () => MyWorld.downedVoidEvent, NPC = EAList.VoidNPC, new Dictionary<string, object>() { ["spawnItems"] = spawnItem = ItemType<VoidEventSummon>(), ["overrideHeadTextures"] = OverrideHeadTextures("DawnOfTheVoidBestiary"), ["customPortrait"] = CustomPortraitVoid("DOTV", 0.85f) });
