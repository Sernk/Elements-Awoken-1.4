...
namespace ElementsAwoken.EASystem.EALayer
{
    public class EAHoneyCocoonLayer : PlayerDrawLayer
    {
        ...
        public override bool GetDefaultVisibility(PlayerDrawSet drawInfo)
        {
            ...
            return modPlayer.honeyCocooned > 0;
        }
        protected override void Draw(ref PlayerDrawSet drawInfo)
        {
            ...
            if (modPlayer.honeyCocooned > 0)
            {
                Texture2D texture = ModContent.Request<Texture2D>("ElementsAwoken/Extra/HoneyCocoonOverlay").Value;
