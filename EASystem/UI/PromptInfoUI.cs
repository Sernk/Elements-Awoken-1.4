...
namespace ElementsAwoken.EASystem.UI
{
    ...
    internal class PromptInfoUI : UIState
    {
        ...
        public override void OnInitialize()
        {
            ...
            gradientA = new Color(73, 94, 171);

            int buttonSize = 44;
            CloseButton = new UIImageButton(ModContent.Request<Texture2D>("ElementsAwoken/Extra/ButtonClose2x2", AssetRequestMode.ImmediateLoad));
            ...
            CloseButton.OnRightClick += CloseButtonClicked;
    ...
    public class UIDisplay : UIElement
    {
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(Request<Texture2D>("ElementsAwoken/Buffs/Prompts/ScorpionBreakout").Value, new Vector2(uiX+ 64, promptY), null, Color.White, 0, Vector2.Zero, 1.5f, SpriteEffects.None, 0f);
            spriteBatch.Draw(Request<Texture2D>("ElementsAwoken/Buffs/Prompts/InfernacesWrath").Value, new Vector2(uiX + 64 * 2, promptY), null, Color.White, 0, Vector2.Zero, 1.5f, SpriteEffects.None, 0f);
            spriteBatch.Draw(Request<Texture2D>("ElementsAwoken/Buffs/Prompts/DarkenedSkies").Value, new Vector2(uiX + 64 * 3, promptY), null, Color.White, 0, Vector2.Zero, 1.5f, SpriteEffects.None, 0f);
            spriteBatch.Draw(Request<Texture2D>("ElementsAwoken/Buffs/Prompts/Hypothermia").Value, new Vector2(uiX + 64 * 4, promptY), null, Color.White, 0, Vector2.Zero, 1.5f, SpriteEffects.None, 0f);
            spriteBatch.Draw(Request<Texture2D>("ElementsAwoken/Buffs/Prompts/StormSurge").Value, new Vector2(uiX + 64 * 5, promptY), null, Color.White, 0, Vector2.Zero, 1.5f, SpriteEffects.None, 0f);
            spriteBatch.Draw(Request<Texture2D>("ElementsAwoken/Buffs/Prompts/Psychosis").Value, new Vector2(uiX + 64 * 6, promptY), null, Color.White, 0, Vector2.Zero, 1.5f, SpriteEffects.None, 0f);
        }
    }
}
