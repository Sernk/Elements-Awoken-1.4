...
namespace ElementsAwoken.EASystem.UI
{
    public class EAUIs : ModSystem
    {
        ...
        //        else
        //        {
        //            TextureAssets.Rain = ModContent.Request<Texture2D>("Images" + Path.DirectorySeparatorChar.ToString() + "Rain");
        //        }
        //        // infernace clouds
        ...
        //            {
        //                TextureAssets.Cloud[cloud] = ModContent.Request<Texture2D>(string.Concat(new object[] { "Extra/Clouds/Cloud_", cloud }));
        //            }
        //        }
        //        else
        //        {
