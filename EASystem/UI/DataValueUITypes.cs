...
{
    // thx modders toolkit source
    class DataValueUITypes<T>
    {
        ...
        public DataValueUITypes(string label, T defaultValue) : this()
        {
            this.label = label;
    ...
    abstract class UIRangedDataValue<T> : DataValueUITypes<T>
    {
