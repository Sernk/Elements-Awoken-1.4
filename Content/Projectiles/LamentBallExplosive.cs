...
namespace ElementsAwoken.Content.Projectiles
{
    public class LamentBallExplosive : ModProjectile
    {
        ...
        {
            Projectile.NewProjectile(EAU.Proj(Projectile), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, ModContent.ProjectileType<LamentExplosion>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
        }
    }
}