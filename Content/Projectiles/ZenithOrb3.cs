...
{
    public class ZenithOrb3 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.owner == Main.myPlayer)
            {
                ...
                if (flag11)
                {
                    ...
                    if (shootTimer <= 0)
                    {
                        Projectile.NewProjectile(EAU.Proj(Projectile), Projectile.Center.X - 4f, Projectile.Center.Y, num404, num405, ModContent.ProjectileType<ZenithBeam3>(), Projectile.damage / 2, Projectile.knockBack, Projectile.owner, 0f, 0f);
                        shootTimer = 8;
                    }
                    return;
                }
