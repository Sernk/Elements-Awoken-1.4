        ...
        public override void AI()
        {
            ...
            if (flag14)
            {
                ...
                if (Projectile.localAI[0] > 16f)
                {
                    ...
                    {
                        Projectile.NewProjectile(EAU.Proj(Projectile), value10.X, value10.Y, num438, num439, ModContent.ProjectileType<YoyoSnowball>(), (int)((double)Projectile.damage * 0.5f), Projectile.knockBack, Projectile.owner, 0f, 0f);
                    }
                }
