...
{
    public class TheEyeP : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (flag14)
            {
                ...
                if (Projectile.localAI[0] > 16f)
                {
                    ...
                    num438 *= num440;
                    num439 *= num440;
                    Projectile.NewProjectile(EAU.Proj(Projectile), value10.X, value10.Y, num438, num439, ModContent.ProjectileType<VoidBlast>(), (int)((double)Projectile.damage * 0.5f), Projectile.knockBack, Projectile.owner, 0f, 0f);
