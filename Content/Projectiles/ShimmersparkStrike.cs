    ...
    public class ShimmersparkStrike : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.rand.Next(2) == 0)
            {
                ...
                Projectile.NewProjectile(EAU.Proj(Projectile), Projectile.Center.X, Projectile.Center.Y, perturbedSpeed.X, perturbedSpeed.Y, ModContent.ProjectileType<ShimmerShrapnel>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
            }
        }
