...
{
    public class BioLightning : ModProjectile
    {
        float timeTillStop = 90;
            ...
            if (Projectile.velocity == Vector2.Zero)
            {
                ...
                if (Main.rand.Next(Projectile.extraUpdates) == 0)
                {
                    for (int num856 = 0; num856 < 2; num856 = num3 + 1)
                    {
                        ...
                        int num859 = Dust.NewDust(Projectile.Center, 0, 0, 131, vector96.X, vector96.Y, 0, default(Color), 1f);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D drawTex = TextureAssets.Extra[33].Value; 
            ...
            for (int num289 = 0; num289 < 3; num289++)
            {
                ...
                if (num289 == 0)
                {
                    ...
                    DelegateMethods.c_1 = new Color(66, 244, 119, 0) * 0.5f;
                }
                else if (num289 == 1)
                {
