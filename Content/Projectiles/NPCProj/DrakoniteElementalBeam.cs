...
{
    public class DrakoniteElementalBeam : ModProjectile
    {
        ...
        public const float LaserLengthMax = 400f;
		int multiplier = 1;
        ...
        public override void AI()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                int num811 = Dust.NewDust(endPoint, 0, 0, 6, vector79.X, vector79.Y, 0, default(Color), 1f);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D tailTex = ModContent.Request<Texture2D>(EAU.ModifyProjTexture("NPCProj/DrakoniteElementalBeamTail")).Value;
            Texture2D beamTex = TextureAssets.Projectile[Projectile.type].Value;
            Texture2D headTex = ModContent.Request<Texture2D>(EAU.ModifyProjTexture("NPCProj/DrakoniteElementalBeamHead")).Value;
            float num228 = LaserLength;
            Color color44 = Color.White * 0.8f * (Projectile.ai[1] >= charge ? 1f : 0.9f);
