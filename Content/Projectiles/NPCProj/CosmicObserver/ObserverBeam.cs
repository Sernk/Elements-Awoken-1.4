...
{
    public class ObserverBeam : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                int num811 = Dust.NewDust(endPoint, 0, 0, 220, vector79.X, vector79.Y, 0, default(Color), 1f);
        ...
        public override void OnHitPlayer(Player target, Player.HurtInfo info)
        {
            ...
            knockBack.Normalize();
            target.velocity = target.velocity + knockBack * strength;
        }
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D tailTex = ModContent.Request<Texture2D>("ElementsAwoken/Content/Projectiles/NPCProj/CosmicObserver/ObserverBeamTail").Value;
            Texture2D beamTex = TextureAssets.Projectile[Projectile.type].Value;
            Texture2D headTex = ModContent.Request<Texture2D>("ElementsAwoken/Content/Projectiles/NPCProj/CosmicObserver/ObserverBeamHead").Value;
