...
namespace ElementsAwoken.Content.Projectiles.NPCProj.RadiantMaster
{
    public class RadiantStasisField : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            EAU.Sb.Draw(auraTex, drawPos - new Vector2(auraTex.Width / 2, auraTex.Height / 2), null, Color.White * 0.6f, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
            ...
            EAU.Sb.Draw(middleTex, drawPos, null, Color.White, Projectile.rotation, middleOrigin, 1f, SpriteEffects.None, 0f);
            return false;
        }
    }
}