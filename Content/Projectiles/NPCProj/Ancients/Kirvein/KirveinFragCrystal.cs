...
{
    public class KirveinFragCrystal : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                Projectile.NewProjectile(EAU.Proj(Projectile), Projectile.Center.X, Projectile.Center.Y, perturbedSpeed.X, perturbedSpeed.Y, ModContent.ProjectileType<KirveinCrystalFragment>(), (int)(Projectile.damage * 0.75f), 0f, 0);
            }
        }
    }
}