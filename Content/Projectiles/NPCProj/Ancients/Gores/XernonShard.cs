    ...
    public class XernonShard : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (parent != null)
            {
                ...
                ProjectileUtils.PushOtherEntities(Projectile, new List<int>() { ModContent.ProjectileType<KirveinShard>(), ModContent.ProjectileType<KrecheusShard>(), ModContent.ProjectileType<IzarisShard>() });
            }
