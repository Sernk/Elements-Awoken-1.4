    ...
    public class KirveinShard : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (parent != null)
            {
                ...
                ProjectileUtils.PushOtherEntities(Projectile, new List<int>() { ModContent.ProjectileType<KrecheusShard>(), ModContent.ProjectileType<XernonShard>(), ModContent.ProjectileType<IzarisShard>() });
            }
