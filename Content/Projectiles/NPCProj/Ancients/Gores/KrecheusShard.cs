    ...
    public class KrecheusShard : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (parent != null)
            {
                ...
                ProjectileUtils.PushOtherEntities(Projectile, new List<int>() { ModContent.ProjectileType<KirveinShard>(), ModContent.ProjectileType<XernonShard>(), ModContent.ProjectileType<IzarisShard>() });
            }
