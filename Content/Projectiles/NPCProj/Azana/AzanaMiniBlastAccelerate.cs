...
{
    public class AzanaMiniBlastAccelerate : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] == 1)
            {
                ...
                {
                    Projectile.NewProjectile(EAU.Proj(Projectile), Projectile.Center, Projectile.velocity.RotatedByRandom(MathHelper.ToRadians(10)) * 0.2f, ModContent.ProjectileType<AzanaCloud>(), Projectile.damage, Projectile.knockBack, Main.myPlayer);
