...
{
    public class AzanaBeamQuick : ModProjectile
    {
        public override string Texture { get { return "ElementsAwoken/Content/Projectiles/NPCProj/Azana/AzanaBeam"; } }
		...
		internal const float charge = 90f;
        ...
        public override void AI()
        {
            ...
            if (multiplier < 0 && Projectile.ai[1] <= 0)
                Projectile.Kill();
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D tailTex = ModContent.Request<Texture2D>("ElementsAwoken/Content/Projectiles/NPCProj/Azana/AzanaBeamTail").Value;
            Texture2D beamTex = TextureAssets.Projectile[Projectile.type].Value;
            Texture2D headTex = ModContent.Request<Texture2D>("ElementsAwoken/Content/Projectiles/NPCProj/Azana/AzanaBeamHead").Value;
            float num228 = LaserLength;
            Color color44 = Color.White * 0.8f * (Projectile.ai[1] >= charge ? 1f : 0.8f) ;
