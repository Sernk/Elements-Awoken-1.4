        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Projectile.owner == Main.myPlayer)
            {
                if (Projectile.ai[1] < 1f)
                {
                    ...
                    int num330 = Projectile.NewProjectile(EAU.Proj(Projectile), Projectile.Center.X - (float)(Projectile.direction * 30), Projectile.Center.Y - 4f, (float)(-(float)Projectile.direction) * 0.01f, 0f, ModContent.ProjectileType<Aquanado>(), num329, 4f, Projectile.owner, 16f, 15f);
                ...
                else
                {
                    ...
                    int num336 = Projectile.NewProjectile(EAU.Proj(Projectile), (float)(num332 * 16 + 8), (float)(num331 * 16 - 24), 0f, 0f, ModContent.ProjectileType<Aquanado>(), num335, 4f, Main.myPlayer, 16f, 24f);
