...
namespace ElementsAwoken.Content.Projectiles.NPCProj.Aqueous
{
    public class AquaticBolt : ModProjectile
    {
        ...
        {
            Projectile.NewProjectile(EAU.Proj(Projectile), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, ModContent.ProjectileType<AquaticBlast>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
        }
    }
}