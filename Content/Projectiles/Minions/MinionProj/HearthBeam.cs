...
{
    public class HearthBeam : ModProjectile
    {
        ...
        public const float LaserLengthMax = 600f;
		int multiplier = 1;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D tailTex = ModContent.Request<Texture2D>("ElementsAwoken/Content/Projectiles/Minions/MinionProj/HearthBeamTail").Value;
            Texture2D beamTex = TextureAssets.Projectile[Projectile.type].Value;
            Texture2D headTex = ModContent.Request<Texture2D>("ElementsAwoken/Content/Projectiles/Minions/MinionProj/HearthBeamHead").Value;
