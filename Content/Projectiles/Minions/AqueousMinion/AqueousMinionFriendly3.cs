...
{
    public class AqueousMinionFriendly3 : ModProjectile
    {
        ...
        {
            Projectile.position.X = Main.player[Projectile.owner].Center.X + 50;
            Projectile.position.Y = Main.player[Projectile.owner].Center.Y + 50;
            bool flag64 = Projectile.type == ModContent.ProjectileType<AqueousMinionFriendly3>();
