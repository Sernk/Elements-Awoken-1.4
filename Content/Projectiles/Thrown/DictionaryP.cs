...
namespace ElementsAwoken.Content.Projectiles.Thrown
{
    ...
    {   	
        ...
        public override void OnKill(int timeLeft)
        {
        	...
        	{
                int item = Item.NewItem(EAU.Proj(Projectile), (int)Projectile.position.X, (int)Projectile.position.Y, Projectile.width, Projectile.height, ModContent.ItemType<Dictionary>());
