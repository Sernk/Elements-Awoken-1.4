...
{
    public class EoiteWave : ModProjectile
    {
        ...
        {
            Projectile.NewProjectile(EAU.Proj(Projectile), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, ModContent.ProjectileType<Explosion>(), (int)(Projectile.damage * 0.75f), Projectile.knockBack, Projectile.owner, 0f, 0f);
