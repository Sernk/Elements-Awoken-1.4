...
{
    public class FusionOrb1 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int dust = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 246, 0f, 0f, 0, new Color(255, Main.DiscoG, 53), 1.2f);
