...
{
    public class DesolationIVHeld : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            float chargeLevel1 = 10f;
            float chargeLevel2 = 30f;
            float chargeLevel3 = 40f;
            ...
            if (Main.myPlayer == Projectile.owner)
            {
                if (player.channel && !player.noItems && !player.CCed)
                {
                    if (Projectile.ai[0] >= chargeLevel3)
                    {
                        ...
                        for (int i = 0; i < numberProjectiles; i++)
                        {
                            ...
                            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, perturbedSpeed.X, perturbedSpeed.Y, ModContent.ProjectileType<DesolationCharge4>(), damage, Projectile.knockBack, player.whoAmI);
                        }
                ...
                else
                {
                    ...
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, vector16.X, vector16.Y, projType, damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
