...
namespace ElementsAwoken.Content.Projectiles.Whips
{
    public class TrueHallowedRadianceP : ModProjectile
    {
        ...
        {       
            ...
            {
                Projectile.NewProjectile(EAU.Proj(Projectile), Projectile.position.X + Projectile.velocity.X, Projectile.position.Y + Projectile.velocity.Y, Projectile.velocity.X * 0.1f, Projectile.velocity.Y * 0.1f, ModContent.ProjectileType<TrueHallowedRadianceScythe>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
            }
