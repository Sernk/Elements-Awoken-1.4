...
{
    public class ShadowsGraspP : ModProjectile
    {
        public override void SetDefaults()
        {
            ...
            Projectile.GetGlobalProjectile<EAProjectileType>().whipAliveTime = 40;
        }
        ...
        {       
            ...
            if (Projectile.alpha == 0)
            {
                ...
                {
                    Dust dust = Main.dust[Dust.NewDust(Projectile.position + Projectile.velocity * 2f, Projectile.width, Projectile.height, 27, 0f, 0f, 100, default(Color), 2f)];
                    dust.noGravity = true;
                    dust.velocity *= 2f;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            int num232 = 5; // how many chains there are
            if (flag24)
            {
                num232 = 3;
            }
