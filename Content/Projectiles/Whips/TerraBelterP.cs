...
{
    public class TerraBelterP : ModProjectile
    {
        public override void SetDefaults()
        {
            ...
            Projectile.GetGlobalProjectile<EAProjectileType>().whipAliveTime = 25;
        }
        ...
        {       
            ...
            {
                Projectile.NewProjectile(EAU.Proj(Projectile), Projectile.position.X + Projectile.velocity.X, Projectile.position.Y + Projectile.velocity.Y, Projectile.velocity.X * Main.rand.NextFloat(0.02f, 0.03f), Projectile.velocity.Y * Main.rand.NextFloat(0.02f, 0.03f), ModContent.ProjectileType<TerraOrb>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
            }
