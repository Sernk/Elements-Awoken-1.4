...
{
    public class MajestyP : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            rectangle8 = new Rectangle(0, 66, texture2D22.Width, 26); 
            if (num230 > 0f)
            {
                float num231 = 0f;
            ...
            rectangle8 = new Rectangle(0, 42, texture2D22.Width, 22); 
            int num232 = 10; // how many chains there are
            if (flag24)
            {
                num232 = 10;
            }
