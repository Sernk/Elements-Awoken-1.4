...
{
    public class LightsAfflictionP : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Rectangle rectangle8 = new Rectangle(0, 0, texture2D22.Width, 42);
            ...
            rectangle8 = new Rectangle(0, 68, texture2D22.Width, 18); 
            if (num230 > 0f)
            {
                float num231 = 0f;
            ...
            rectangle8 = new Rectangle(0, 46, texture2D22.Width, 18); 
            int num232 = 20;
            if (flag24)
            {
                num232 = 10;
            ...
            rectangle8 = new Rectangle(0, 90, texture2D22.Width, 48); //end
