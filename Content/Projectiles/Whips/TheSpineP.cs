...
{
    public class TheSpineP : ModProjectile
    {
        ...
        {       
            ...
            if (Projectile.alpha == 0)
            {
                ...
                {
                    Dust dust = Main.dust[Dust.NewDust(Projectile.position + Projectile.velocity * 2f, Projectile.width, Projectile.height, 5, 0f, 0f, 100, default(Color), 2f)];
                    dust.noGravity = true;
                    dust.velocity *= 2f;
                ...
                while ((float)num53 < num52)
                {
                    if (Main.rand.Next(4) == 0)
                    {
                        ...
                        Dust dust2 = Main.dust[Dust.NewDust(position, Projectile.width, Projectile.height, 60, 0f, 0f, 100, default(Color), 1f)];
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            {
                Projectile.NewProjectile(EAU.Proj(Projectile), target.Center.X, target.Center.Y, 0f, 0f, ModContent.ProjectileType<HealProjBlood>(), 0, 0f, Main.myPlayer, Main.myPlayer, Main.rand.Next(1, 4)); // ai 1 is how much it heals
            }
        }
    }
}