...
{
    public class TheTrueSpineP : ModProjectile
    {
        ...
        {       
            ...
            {
                Projectile.NewProjectile(EAU.Proj(Projectile), Projectile.position.X + Projectile.velocity.X, Projectile.position.Y + Projectile.velocity.Y, Projectile.velocity.X * 0.075f, Projectile.velocity.Y * 0.075f, ModContent.ProjectileType<TrueSpineBall>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
            }
            ...
            if (Projectile.alpha == 0)
            {
                ...
                {
                    Dust dust = Main.dust[Dust.NewDust(Projectile.position + Projectile.velocity * 2f, Projectile.width, Projectile.height, 170, 0f, 0f, 100, default(Color), 1f)];
                    dust.noGravity = true;
                    dust.velocity *= 2f;
                ...
                while ((float)num53 < num52)
                {
                    if (Main.rand.Next(6) == 0)
                    {
                        ...
                        Dust dust2 = Main.dust[Dust.NewDust(position, Projectile.width, Projectile.height, 169, 0f, 0f, 100, default(Color), 1f)];
        ...
        {
            target.AddBuff(BuffID.Ichor, 30, false);
            if (Main.rand.Next(5) == 0)
            {
                Projectile.NewProjectile(EAU.Proj(Projectile), target.Center.X, target.Center.Y, 0f, 0f, ModContent.ProjectileType<HealProjBlood>(), 0, 0f, Main.myPlayer, Main.myPlayer, Main.rand.Next(2, 6)); // ai 1 is how much it heals
            }
        }
    }
}