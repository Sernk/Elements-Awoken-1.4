...
{
    public class FlarelashP : ModProjectile
    {
        ...
        {       
            ...
            if (Projectile.alpha == 0)
            {
                ...
                {
                    Dust dust = Main.dust[Dust.NewDust(Projectile.position + Projectile.velocity * 2f, Projectile.width, Projectile.height, 6, 0f, 0f, 100, default(Color), 2f)];
                    dust.noGravity = true;
                    dust.velocity *= 2f;
                ...
                while ((float)num53 < num52)
                {
                    if (Main.rand.Next(4) == 0)
                    {
                        ...
                        Dust dust2 = Main.dust[Dust.NewDust(position, Projectile.width, Projectile.height, 6, 0f, 0f, 100, default(Color), 1f)];
