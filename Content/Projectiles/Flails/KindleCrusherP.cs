...
{
    public class KindleCrusherP : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (deathTimer > 50)
            {
                ...
                {
                    Projectile.NewProjectile(EAU.Proj(Projectile), Projectile.Center.X, Projectile.Center.Y, Main.rand.Next(-2, 2), Main.rand.Next(-2, 2), ModContent.ProjectileType<KindleFireball>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
                }
            }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D texture = ModContent.Request<Texture2D>("ElementsAwoken/Content/Projectiles/Flails/KindleCrusherChain").Value;
