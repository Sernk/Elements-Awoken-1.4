...
namespace ElementsAwoken.Content.Items.Weapons.Melee.Whips
{
    public class TerraBelter : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.autoReuse = true;
            Item.noMelee = true;
            Item.shoot = ModContent.ProjectileType<TerraBelterP>();
            Item.shootSpeed = 15f;
        }
        public override void AddRecipes()
        {
            Recipe recipe = CreateRecipe();
            recipe.AddIngredient(ModContent.ItemType<TrueHallowedRadiance>(), 1);
            recipe.AddIngredient(ModContent.ItemType<TheTrueSpine>(), 1);
            recipe.AddTile(TileID.MythrilAnvil);
            recipe.Register();

            recipe = CreateRecipe();
            recipe.AddIngredient(ModContent.ItemType<TrueHallowedRadiance>(), 1);
            recipe.AddIngredient(ModContent.ItemType<TrueNightbreaker>(), 1);
            recipe.AddTile(TileID.MythrilAnvil);
            recipe.Register();
        }
