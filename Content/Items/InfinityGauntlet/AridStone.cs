...
namespace ElementsAwoken.Content.Items.InfinityGauntlet
{
    public class AridStone : ModItem
    {
        ...
        public override void UpdateInventory(Player player)
        {
            ...
            {
                if (player.HasItem(ModContent.ItemType<MoonStone>()) || player.HasItem(ModContent.ItemType<PyroStone>()) || player.HasItem(ModContent.ItemType<AquaticStone>()) || player.HasItem(ModContent.ItemType<FrigidStone>()) || player.HasItem(ModContent.ItemType<DeathStone>()))
                {
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<DesertEssence>(), 16);
