...
{
    public class SolarGeneratorIII : ModItem
    {
        ...
        public override void UpdateInventory(Player player)
        {
            ...
            if (modPlayer.energy < modPlayer.maxEnergy && Main.dayTime)
            {
                ...
                productionAmount = (int)Math.Round(MathHelper.Lerp(4, 2, MathHelper.Distance((float)Main.time, 27000) / 27000));
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<SolarGeneratorII>(), 1);
            recipe.AddIngredient(ItemID.ChlorophyteBar, 12);
            recipe.AddIngredient(ItemID.Seashell, 4);
            recipe.AddIngredient(ModContent.ItemType<RoyalScale>(), 1);
