...
namespace ElementsAwoken.Content.Items.Tech.Weapons.Tier4
{
    public class Shrinkinator : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.rare = 5;
            Item.shootSpeed = 6f;
            Item.shoot = ModContent.ProjectileType<ShrinkinatorP>();
        }
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 speed, int type, int damage, float knockback)
        {
            Projectile.NewProjectile(source, position.X, position.Y, speed.X, speed.Y, ModContent.ProjectileType<ShrinkinatorP>(), damage, knockback, player.whoAmI, 0.0f, 0.0f);
            return false;
        }
