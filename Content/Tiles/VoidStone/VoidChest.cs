...
namespace ElementsAwoken.Content.Tiles.VoidStone
{
    public class VoidChest : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(51, 51, 51), this.GetLocalization("MapEntry1"), MapChestName);
            DustType = 79;
        ...
        {
            _ = this.GetLocalization("VoidChest").Value;
        }
        public override LocalizedText DefaultContainerName(int frameX, int frameY)
        {
            int option = frameX / 36;
            return this.GetLocalization("VoidChest");
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            else
            {
                ...
                {
                    player.cursorItemIconID = ModContent.ItemType<Items.Placeable.VoidStone.VoidChest>();
