...
namespace ElementsAwoken.Content.NPCs.ArmoredTrencher
{
    class ArmoredTrencherHead : ArmoredTrencher
    {
        public override string Texture { get { return "ElementsAwoken/Content/NPCs/ArmoredTrencher/ArmoredTrencherHead"; } }
        ...
        public override void SetStaticDefaults()
        {
            ...
            {
                CustomTexturePath = "ElementsAwoken/Extra/Bestiary/ArmoredTrencherBestiary",
                Scale = 0.8f,
                PortraitScale = 0.8f,
            };
        ...
        {
            bestiaryEntry.Info.AddRange([new FlavorTextBestiaryInfoElement("Mods.ElementsAwoken.Bestiary.Enemies.ArmoredTrencher"), 
        ...
        {
            bool underworld = (spawnInfo.SpawnTileY <= (Main.maxTilesY * 0.6f));
            ...
            underworld && rockLayer && !Main.snowMoon && !Main.pumpkinMoon && NPC.downedMoonlord ? 0.009f : 0f;
        }
    }

    class ArmoredTrencherBody : ArmoredTrencher
    {
        public override string Texture { get { return "ElementsAwoken/Content/NPCs/ArmoredTrencher/ArmoredTrencherBody"; } }
    ...
    class ArmoredTrencherTail : ArmoredTrencher
    {
        public override string Texture { get { return "ElementsAwoken/Content/NPCs/ArmoredTrencher/ArmoredTrencherTail"; } }
    ...
    public abstract class ArmoredTrencher : Worm
    {
        public override void SetStaticDefaults()
        {
        }
            ...
            if (Main.netMode != NetmodeID.MultiplayerClient)
            {
                if (!tail && NPC.ai[0] == 0f)
                {
                    if (head)
                    {
                        ...
                        NPC.ai[0] = (float)NPC.NewNPC(EAU.NPCs(NPC), (int)(NPC.position.X + (float)(NPC.width / 2)), (int)(NPC.position.Y + (float)NPC.height), bodyType, NPC.whoAmI);
                    }
                    else if (NPC.ai[2] > 0f)
                    {
                        NPC.ai[0] = (float)NPC.NewNPC(EAU.NPCs(NPC), (int)(NPC.position.X + (float)(NPC.width / 2)), (int)(NPC.position.Y + (float)NPC.height), NPC.type, NPC.whoAmI);
                    }
                    else
                    {
                        NPC.ai[0] = (float)NPC.NewNPC(EAU.NPCs(NPC), (int)(NPC.position.X + (float)(NPC.width / 2)), (int)(NPC.position.Y + (float)NPC.height), tailType, NPC.whoAmI);
                    }
