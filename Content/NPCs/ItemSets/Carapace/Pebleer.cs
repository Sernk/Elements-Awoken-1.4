...
namespace ElementsAwoken.Content.NPCs.ItemSets.Carapace
{
    public class Pebleer : ModNPC
    {
        ...
        {
            bestiaryEntry.Info.AddRange([new FlavorTextBestiaryInfoElement("Mods.ElementsAwoken.Bestiary.Enemies.Pebleer"),
        ...
        {
            npcLoot.Add(ItemDropRule.Common(ItemType<CarapaceItem>(), 1, 1, 3));
            npcLoot.Add(ItemDropRule.Common(ItemType<PebleerEgg>(), 6));
        }
