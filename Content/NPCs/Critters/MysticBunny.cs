...
namespace ElementsAwoken.Content.NPCs.Critters
{
    public class MysticBunny : ModNPC
    {
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            if (NPC.life <= 0)
            {
                Gore.NewGore(EAU.NPCs(NPC), NPC.position, NPC.velocity, Mod.Find<ModGore>("MysticBunny").Type, 1f);
                Gore.NewGore(EAU.NPCs(NPC), NPC.position, NPC.velocity, Mod.Find<ModGore>("MysticBunny1").Type, 1f);
            }
        }
