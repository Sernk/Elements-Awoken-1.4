...
namespace ElementsAwoken.Content.NPCs.Bosses.Infernace
{
    public class RockSmall : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            {
                NPC.velocity += new Vector2(Main.rand.NextFloat(-3f, 3f), Main.rand.NextFloat(-3f, 3f));
            }
            ...
            for (int k = 0; k < Main.npc.Length; k++)
            {
                ...
                if (k != NPC.whoAmI && (other.type == NPC.type || other.type == ModContent.NPCType<RockLarge>() || other.type == ModContent.NPCType<RockMedium>())
