...
namespace ElementsAwoken.Content.NPCs.Elementals
{
    public class DesertElemental : ModNPC
    {
        public override void SetDefaults()
        {
            ...
            Banner = NPC.type;
            BannerItem = ModContent.ItemType<DesertElementalBanner>();
        }
        ...
        {
            bestiaryEntry.Info.AddRange([new FlavorTextBestiaryInfoElement("Mods.ElementsAwoken.Bestiary.Enemies.DesertElemental"), 
        ...
        {
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<DesertEssence>(), 1));
            npcLoot.Add(ItemDropRule.Common(ItemID.SandBlock, 1, 10, 30));
        }
