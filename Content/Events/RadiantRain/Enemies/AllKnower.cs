...
{
    class AllKnowerHead : AllKnower
    {
        public override string Texture { get { return "ElementsAwoken/Content/Events/RadiantRain/Enemies/AllKnowerHead"; } }
        ...
        public override void SetStaticDefaults()
        {
            ...
            {
                CustomTexturePath = "ElementsAwoken/Extra/Bestiary/AllKnowerBestiary",
                Scale = 1.7f, // Мини иконка в бестиарии 
                PortraitScale = 1.4f, // При нажатии на иконку в бестиарии
            };
            value.Position.X += 20;
            value.Position.Y += 15;
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange([
                ...
                new FlavorTextBestiaryInfoElement("Mods.ElementsAwoken.Bestiary.Enemies.AllKnower"),
            ]);
        }
    ...
    class AllKnowerBody : AllKnower
    {
        public override string Texture { get { return "ElementsAwoken/Content/Events/RadiantRain/Enemies/AllKnowerBody"; } }
    ...
    class AllKnowerTail : AllKnower
    {
        public override string Texture { get { return "ElementsAwoken/Content/Events/RadiantRain/Enemies/AllKnowerTail"; } }
    ...
    public abstract class AllKnower : Worm
    {
        public override void SetStaticDefaults()
        {
        }
        public override void Init()
        {
            tailType = NPCType<AllKnowerTail>();
            bodyType = NPCType<AllKnowerBody>();
            headType = NPCType<AllKnowerHead>();
            minLength = 7;
            maxLength = 12;
            speed = 14f;
            turnSpeed = 0.05f;
    ...
    public abstract class Worm : ModNPC
    {
        ...
        private void FallThroughPlatforms()
        {
            if (head)
            {
                ...
                if (TileID.Sets.Platforms[platformTile.TileType] && NPC.Bottom.Y < P.Bottom.Y && platformTile.HasTile)
                {
                    NPC.collideX = false;
                    NPC.collideY = false;
